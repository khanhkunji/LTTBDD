...
## V. MA TRẬN PHÂN QUYỀN THAO TÁC DỮ LIỆU

Dưới đây là bảng phân định quyền hạn chi tiết của từng nhóm người dùng đối với các thực thể (bảng dữ liệu) trong hệ thống:

| Nhóm Dữ Liệu (Thực thể) | Khách hàng (User) | Quản trị viên (Admin) | Quản trị cấp cao (Super Admin) |
| :--- | :--- | :--- | :--- |
| **`NGUOIDUNG`**<br>*(Tài khoản)* | - Đăng ký mới.<br>- Xem & Sửa thông tin cá nhân của chính mình. | - Xem danh sách khách hàng.<br>- Khóa/Mở khóa tài khoản khách hàng. | - Toàn quyền Admin.<br>- **Phân quyền:** Cấp/Gỡ quyền Admin cho tài khoản khác. |
| **`DANHMUC`**<br>**`SANPHAM`**<br>**`SANPHAM_SIZE`**<br>*(Kho hàng)* | - **Chỉ Xem** (Read-only).<br>- Tìm kiếm, lọc sản phẩm, xem tồn kho. | - **Toàn quyền (CRUD)**.<br>- Thêm/Sửa/Xóa danh mục, sản phẩm.<br>- Cập nhật giá và tồn kho. | - **Toàn quyền (CRUD)** như Admin. |
| **`GIOHANG`**<br>**`CHITIET_GIOHANG`**<br>*(Giỏ hàng)* | - **Toàn quyền với giỏ hàng của mình**.<br>- Thêm/Sửa số lượng/Xóa SP. | - **Không có quyền truy cập** (Đảm bảo tính riêng tư mua sắm). | - **Không có quyền truy cập**. |
| **`DONHANG`**<br>**`CHITIET_DONHANG`**<br>**`THANHTOAN`**<br>*(Giao dịch)* | - Đặt hàng (Tạo mới).<br>- Xem lịch sử đơn của mình.<br>- Hủy đơn (khi đang chờ xác nhận).<br>- Tạo thanh toán. | - Xem toàn bộ đơn hàng.<br>- **Cập nhật trạng thái** (Duyệt/Giao).<br>- Xem mã giao dịch đối soát. | - Toàn quyền như Admin.<br>- **Truy xuất báo cáo** doanh thu, thống kê bán hàng. |
| **`DANHGIA`**<br>*(Tương tác)* | - Viết đánh giá mới (chỉ khi đã mua SP đó thành công).<br>- Xem đánh giá của người khác. | - Kiểm duyệt bình luận (Duyệt hiển thị).<br>- Ẩn/Xóa bình luận vi phạm. | - Toàn quyền kiểm duyệt như Admin. |
